                ...
                <table class="table table-bordered hide mt-4">
                  ...
                  <tbody id="tbody">
                    <tr>
                      <th>1</th>
                      <th>
                        <input type="text" class="form-control" name="label" name="" placeholder="Enter label">
                      </th>
                      <th>
                        <input type="text" class="form-control parent-route" name="route" placeholder="Route">
                      </th>
                      <th>
