    ...
    <div id="header" class="head-tr bottom">
        <div class="container container-header">
            ...
            <div class="left-side">
                <!-- Logo -->
                <div id="logo">
                    <a href="index.html"><img src="{{ url('/') }}/frontend/images/logo-white-1.svg" data-sticky-logo="images/logo-red.svg" alt=""></a>
                </div>
                <!-- Mobile Navigation -->
            ...
            <div class="header-user-menu user-menu add">
                <div class="header-user-name">
                    <span><img src="{{ url('/') }}/frontend/images/testimonials/ts-1.jpg" alt=""></span>Hi, Mary!
                </div>
                <ul>
            ...
            <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                ...
                <div class="header-widget sign-in">
                    <div class="show-reg-form modal-open"><a href="{{ url('admin-login') }}">Sign In</a></div>
                </div>
                <!-- Header Widget / End -->
            </div>
            <!-- Right Side Content / End -->
